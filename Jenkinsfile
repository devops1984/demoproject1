			...
			steps{
				 ...
				 [sshPublisherDesc(configName: 'jenkins', 
				     transfers: [sshTransfer(cleanRemote: false, 
					  excludes: '', execCommand: 'sudo rsync -avh  /var/lib/jenkins/workspace/demoproject/* --exclude "pom.xml" --exclude "Jenkinsfile" --exclude "Dockerfile" --exclude "webapp" --exclude "README.md" --exclude "server"  deploy@172.31.12.188:/home/deploy/demoproject', 
